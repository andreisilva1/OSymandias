...
class MemoryManager:
    ...
    def search_sync(
        ...
        from osymandias.runtime.memory.embeddings import generate_embedding
        from osymandias.runtime.memory import qdrant_client as qc
        from osymandias.runtime.memory.reranker import rerank
